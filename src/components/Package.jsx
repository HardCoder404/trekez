      ...
      <ul className="package-list">
        ...
        <li>
          <div className="package-card">
            ...
            <figure className="card-banner">
              <img src="https://content.api.news/v3/images/bin/eea313fbbde13d85024f2fed9f4e2d6c" alt="Experience The Great Holiday On Beach" loading="lazy"/>
            </figure>
        ...
        <li>
          <div className="package-card">
            ...
            <figure className="card-banner">
              <img src="https://www.goa.biz/wp-content/uploads/2023/07/HotAirBalloon-1024x681.jpg" alt="Summer Holiday To The Oxolotan River" loading="lazy"/>
            </figure>
        ...
        <li>
          <div className="package-card">
            ...
            <figure className="card-banner">
              <img src="https://fcdn.antelope-travel.com/export/simg/96cc0d61-0834-45f8-a3d8-e62fe325ec64.jpg" alt="Santorini Island's Weekend Vacation" loading="lazy"/>
            </figure>
